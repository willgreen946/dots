...
" Normal Mode:
let s:N1 = [ '#121212' , '#f2ca30' , 235 , 73 ] " Mode
let s:N2 = [ '#f0f0f0' , '#323232' , 252 , 240  ] " Info
let s:N3 = [ '#f0f0f0' , '#323232' , 248 , 235 ] " StatusLine
...
" Insert Mode:
let s:I1 = [ '#f0f0f0' , '#54487a' , 254 , 54 ] " Mode
let s:I2 = [ '#f0f0f0' , '#323232' , 252 , 240  ] " Info
let s:I3 = [ '#f0f0f0' , '#323232' , 248 , 235 ] " StatusLine
...
" Visual Mode:
let s:V1 = [ '#f0f0f0', '#f26711', 235, 32 ]
let s:V2 = [ '',        '#323232', '',  240  ]
let s:V3 = [ '#f0f0f0', '#323232', 248, 235 ]
