...
let g:colors_name="gred"

hi ColorColumn  term=NONE cterm=NONE ctermfg=3    ctermbg=1
...
hi DiffAdd      term=NONE cterm=NONE ctermfg=10   ctermbg=NONE
...
hi Directory    term=NONE cterm=NONE ctermfg=1    ctermbg=NONE
...
hi Function     term=NONE cterm=NONE ctermfg=88   ctermbg=NONE
hi Identifier   term=NONE cterm=NONE ctermfg=88   ctermbg=NONE
hi IncSearch    term=NONE cterm=NONE ctermfg=88   ctermbg=242
hi NonText      term=NONE cterm=NONE ctermfg=88   ctermbg=NONE
...
hi Special      term=NONE cterm=NONE ctermfg=88   ctermbg=NONE
hi SpecialKey   term=NONE cterm=NONE ctermfg=242  ctermbg=NONE
hi Statement    term=NONE cterm=NONE ctermfg=1  ctermbg=NONE
hi StatusLine   term=NONE cterm=NONE ctermfg=242  ctermbg=88
hi StatusLineNC term=NONE cterm=NONE ctermfg=242  ctermbg=NONE
hi String       term=NONE cterm=NONE ctermfg=242  ctermbg=NONE
hi TabLineSel   term=NONE cterm=NONE ctermfg=251  ctermbg=NONE
hi Todo         term=NONE cterm=NONE ctermfg=251  ctermbg=238
hi Type         term=NONE cterm=NONE ctermfg=9    ctermbg=NONE
hi VertSplit    term=NONE cterm=NONE ctermfg=242  ctermbg=88
hi Visual       term=NONE cterm=NONE ctermfg=1    ctermbg=242
hi WarningMsg   term=NONE cterm=NONE ctermfg=256  ctermbg=88
hi LineNr       term=NONE cterm=NONE ctermbg=NONE ctermfg=238
hi CursorLineNr term=NONE cterm=NONE ctermbg=1    ctermfg=16
